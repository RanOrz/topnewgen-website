...
const copy = {
  en: {
    hero: {
      ...
      subtitle:
        "Numbers tell the story. Use our interactive planning tools to quickly assess your protection needs and make well-informed decisions for your family's financial security.",
    },
    section: {
      title: "Planning Tools",
      subtitle:
        "Our calculators are under development and coming soon. In the meantime, please contact our advisors for a one-on-one personalized assessment.",
    },
    comingSoonBadge: "Coming Soon",
    comingSoonButton: "Calculator Coming Soon",
    cta: {
      title: "While the Calculators Are Launching, Let Us Assess for You",
      body: "Our professional advisors can conduct a comprehensive coverage needs analysis based on your specific situation, providing more accurate and personalized recommendations than an online calculator.",
      button: "Book a Free Needs Assessment",
    },
    calculators: [
      {
        title: "Life Insurance Needs Calculator",
        description:
          "Based on factors such as your household income, debts, living expenses, and children's ages, calculate the life insurance coverage amount you need — ensuring your family's quality of life is protected after you're gone.",
        features: [
          "Account for monthly household expenses",
          "Include existing debts",
          "Calculate education expense reserves",
      ...
      },
      {
        ...
        description:
          "Set your retirement age, expected monthly expenses, and retirement duration to calculate how much you need to accumulate, and explore the feasibility of tax-free retirement income through an Indexed Universal Life (IUL) policy.",
        features: [
          "Set target retirement age",
          "Estimate post-retirement monthly expenses",
          "Compare different savings strategies",
          "Simulate tax-free withdrawal benefits",
        ],
      },
      {
        title: "College Education Funding Calculator",
        description:
          "Based on your child's age and the estimated tuition at target universities, calculate how much to save each month and compare the long-term benefits and flexibility of 529 plans versus life insurance cash value.",
        features: [
          "Child's age and target timeline",
          "Estimated total four-year college costs",
          "Compare 529 vs. life insurance options",
  ...
  zh: {
    ...
    comingSoonButton: "計算器即將推出",
    cta: {
      title: "計算器上線前，讓我們親自為您評估",
      body: "我們的專業顧問可以根據您的具體情況進行全面的保障需求分析，提供比線上計算器更精確、更個人化的建議。",
      button: "預約免費需求評估",
    },
    calculators: [
      {
...
const calcIcons = [ShieldCheck, Wallet, GraduationCap]
