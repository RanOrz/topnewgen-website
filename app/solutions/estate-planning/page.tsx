...
export const metadata: Metadata = {
  title: "遺產規劃 | 新睿保險集團",
  description:
    "新睿保險集團以人壽保險為核心工具，幫助您打造高效的遺產規劃策略。免稅財富轉移、應對遺產稅、確保資產按意願傳承，讓您的財富完整留給下一代。",
}
    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-primary mb-6">為什麼遺產規劃如此重要？</h2>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-primary mb-4">遺產規劃的核心問題</h3>
              {[
      ...
      <section className="py-16 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary mb-4">人壽保險在遺產規劃中的角色</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: TrendingUp,
                title: "遺產均等分配",
                desc: "若您的主要資產是一筆無法分割的財產（如家族企業或特定房產），人壽保險可以作為「補償」工具。例如讓一個子女繼承企業，同時以壽險理賠金補償其他子女，實現公平分配。",
              },
              {
                icon: CheckCircle2,
                title: "慈善遺產規劃",
      ...
      <section className="py-16 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-primary mb-6">遺產規劃的核心優勢</h2>
            ...
            <div className="space-y-6">
              <div className="bg-secondary rounded-2xl p-8">
                <h3 className="text-xl font-bold text-primary mb-6">遺產傳承效率比較</h3>
                <div className="space-y-4">
                  {[
                    {
                      method: "直接遺留現金/投資帳戶",
                    ...
                    <div key={i} className="p-4 bg-card rounded-xl">
                      ...
                      <div className="text-xs text-muted-foreground mb-1">稅務：{item.tax}</div>
                      <div className="text-xs text-muted-foreground mb-2">時間：{item.time}</div>
                      <div className="flex items-center gap-2">
                        <div className="text-xs font-bold text-accent-foreground">傳承效率：</div>
                        <div className={`text-xs font-bold ${i === 2 ? "text-green-600" : "text-muted-foreground"}`}>{item.efficiency}</div>
                      </div>
                    </div>
                  ))}
                </div>
                <p className="text-xs text-muted-foreground mt-4 italic">* 效率估算依個人情況、稅法和架構設計而異。</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-primary mb-10 text-center">常見遺產規劃策略</h2>
      ...
      <section className="py-16 bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-primary mb-10 text-center">誰需要遺產規劃？</h2>
      ...
      <section className="py-16 bg-accent">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-accent-foreground mb-4">讓您的財富完整傳承</h2>
