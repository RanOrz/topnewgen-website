...
import { Shield, Users, Award, Heart, CheckCircle, Star } from "lucide-react"
    ...
    <main className="min-h-screen">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-primary mb-5">我們的發展歷程</h3>
              {milestones.map((item, index) => (
                <div key={index} className="flex gap-4 items-start">
                  ...
                  <div className="flex-shrink-0 flex flex-col items-center">
                    ...
                    {index < milestones.length - 1 && <div className="w-0.5 h-12 bg-border mt-1" />}
                  </div>
      ...
      <section className="py-20 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">讓每個家庭擁有安心的明天</h2>
