...
const carriers = [
  "Allianz", "AIG", "Nationwide", "Pacific Life", "John Hancock",
  "Mutual of Omaha", "Transamerica", "North American", "Global Atlantic", "F&G",
]
...
const copy = {
  en: {
    ...
    missionP1: "Our mission is to help every family navigate life's unpredictable risks with confidence and financial security through comprehensive, integrity-driven insurance advisory services.",
    missionP2: "Insurance is more than a contract — it is the deepest promise you can make to the people you love. We believe every family deserves the best protection, and it is our responsibility to make that promise a reality.",
    valuesEyebrow: "Core Values",
    valuesHeading: "The Principles We Stand By",
    values: [
      { title: "Integrity First", description: "Integrity is the foundation of everything we do. Every recommendation and every policy is guided by the client's best interest — never influenced by commissions or short-term gains." },
      { title: "Professional Excellence", description: "Our advisors hold top industry certifications and pursue ongoing education to stay current with insurance regulations and product innovations, ensuring you receive the most accurate and timely guidance." },
      { title: "Personalized Service", description: "Every family's needs are unique. We take the time to understand your financial goals, family situation, and risk tolerance to design a protection plan tailored specifically to you." },
      { title: "Long-Term Partnership", description: "We are not just selling insurance — we are your long-term financial protection partner. From claims assistance after enrollment to policy reviews at every stage of life, we are always by your side." },
    ],
    carriersEyebrow: "Our Carrier Partners",
    carriersHeading: "Partnered with Top Insurance Carriers",
    carriersSubtext: "As an independent insurance agency, we work with more than 10 of the most trusted insurance companies in the country, ensuring we can compare and identify the best protection plan for you.",
  },
  zh: {
    stats: [
    ...
    missionP1: "我們的使命是透過全面、誠信的保險諮詢服務，幫助每一個家庭在面對人生中不可預期的風險時，能夠從容應對、生活無虞。",
    missionP2: "保險不只是一份合約，更是對家人最深切的承諾。我們相信，每個家庭都值得擁有最好的保障，而我們的責任，就是讓這份承諾成真。",
    valuesEyebrow: "核心價值觀",
    valuesHeading: "我們堅守的原則",
    values: [
      { title: "誠信為本", description: "我們以誠信作為一切業務的基石。每一個建議、每一份保單，都以客戶的最大利益為出發點，絕不因佣金或短期利益而影響我們對客戶的建議。" },
      { title: "專業卓越", description: "我們的顧問團隊持有業界頂尖認證，並持續進行專業教育，緊跟保險法規與產品創新動態，確保為您提供最精準、最具時效性的保障建議。" },
      { title: "個性化服務", description: "每個家庭的需求都是獨一無二的。我們深入了解您的財務目標、家庭狀況與風險承受能力，量身定制最適合您的保障方案，而非千篇一律的套裝產品。" },
      { title: "長期夥伴", description: "我們不只是賣保險，更是您的長期財務保障夥伴。從投保後的理賠協助，到人生各階段的保障檢視與調整，我們始終陪伴在您身邊。" },
    ],
    carriersEyebrow: "合作保險公司",
    carriersHeading: "與頂級保險公司合作",
    carriersSubtext: "作為獨立保險代理人，我們與超過10家全美最受信賴的保險公司合作，確保能為您比較、篩選出最優質的保障方案。",
  },
}
...
export function AboutSection() {
  ...
  return (
    <>
      {/* Stats Bar */}
      <section id="about" className="bg-accent py-10">
      ...
      <section className="py-20 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed mb-4">{t.missionP1}</p>
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">{t.missionP2}</p>
        </div>
      </section>
